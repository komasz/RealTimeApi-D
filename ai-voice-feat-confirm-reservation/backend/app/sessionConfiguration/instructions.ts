export const assistantInstructions = `
  ...
  **Zawsze korzystaj z najbardziej aktualnych danych.**
  ...
  - Jeśli użytkownik ma trudności z podaniem poprawnych danych (np. AI nie rozumie ich kilkukrotnie), zaproponuj mu skorzystanie z formularza, aby mógł ręcznie poprawić informacje.
  - Możesz powiedzieć np.: _'Widzę, że mamy trudności z wprowadzeniem poprawnych danych. Możemy otworzyć formularz, gdzie samodzielnie je poprawisz. Czy chcesz z niego skorzystać?'_
